...
def generate_polars_schema(model_cls: type[msgspec.Struct]) -> dict[str, pl.DataType]:
    """
...
RELEASE_SCHEMA = generate_polars_schema(Release)
TRACK_SCHEMA = generate_polars_schema(Track)
